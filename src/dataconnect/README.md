...
You can use this generated SDK by importing from the package `@gods-way/dataconnect` as shown below. Both CommonJS and ESM imports are supported.

You can also follow the instructions from the [Data Connect documentation](https://firebase.google.com/docs/data-connect/web-sdk#set-client).

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listProducts } from '@gods-way/dataconnect';
...
import { connectorConfig, listProductsRef } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listOrders } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, listOrdersRef } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getUser, GetUserVariables } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getUserRef, GetUserVariables } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listUsers } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, listUsersRef } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createProduct, CreateProductVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const { data } = await createProduct({ id: ..., sku: ..., name: ..., category: ..., emoji: ..., image: ..., price: ..., cost: ..., stock: ..., compat: ..., status: ..., createdAt: ..., updatedAt: ..., });
...
import { connectorConfig, createProductRef, CreateProductVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const ref = createProductRef({ id: ..., sku: ..., name: ..., category: ..., emoji: ..., image: ..., price: ..., cost: ..., stock: ..., compat: ..., status: ..., createdAt: ..., updatedAt: ..., });
...
## UpdateProduct
You can execute the `UpdateProduct` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `UpdateProduct` mutation requires an argument of type `UpdateProductVariables`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `UpdateProductData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateProduct, UpdateProductVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const { data } = await updateProduct({ id: ..., sku: ..., name: ..., category: ..., emoji: ..., image: ..., price: ..., cost: ..., stock: ..., compat: ..., status: ..., updatedAt: ..., });
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateProductRef, UpdateProductVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const ref = updateProductRef({ id: ..., sku: ..., name: ..., category: ..., emoji: ..., image: ..., price: ..., cost: ..., stock: ..., compat: ..., status: ..., updatedAt: ..., });
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteProduct, DeleteProductVariables } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteProductRef, DeleteProductVariables } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createOrder, CreateOrderVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const { data } = await createOrder({ id: ..., customer: ..., items: ..., total: ..., payment: ..., status: ..., time: ..., createdAt: ..., createdBy: ..., });
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, createOrderRef, CreateOrderVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const ref = createOrderRef({ id: ..., customer: ..., items: ..., total: ..., payment: ..., status: ..., time: ..., createdAt: ..., createdBy: ..., });
...
## UpdateOrder
You can execute the `UpdateOrder` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `UpdateOrder` mutation requires an argument of type `UpdateOrderVariables`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `UpdateOrderData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateOrder, UpdateOrderVariables } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateOrderRef, UpdateOrderVariables } from '@gods-way/dataconnect';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createUser, CreateUserVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const { data } = await createUser({ id: ..., email: ..., role: ..., displayName: ..., photoURL: ..., createdAt: ..., });
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, createUserRef, CreateUserVariables } from '@gods-way/dataconnect';
...
// Variables can be defined inline as well.
const ref = createUserRef({ id: ..., email: ..., role: ..., displayName: ..., photoURL: ..., createdAt: ..., });
